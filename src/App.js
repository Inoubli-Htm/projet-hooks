...
// Find Movie
const findMovie=(titre)=>{

  setMovies(movies.filter(movie=>movie.title===titre));
}
  return (
    <div className="App">
  
<NavBar getText={getText} getRate={getRate} findMovie={findMovie} />
<AddMovie addMovie={addMovie} />
<MovieList  movies={movies} deleteMovie={deleteMovie} text={text} rate={rate} />
    </div>
  );
}
